...
Task({ agent_type: "general-purpose", prompt: "Entity verification" })
Task({ agent_type: "general-purpose", prompt: "Leadership backgrounds" })
Task({ agent_type: "general-purpose", prompt: "Competitive analysis" })
Task({ agent_type: "general-purpose", prompt: "Risk assessment" })
```
...
```
~/.pai/History/research/YYYY-MM/[target]-osint/
  README.md
