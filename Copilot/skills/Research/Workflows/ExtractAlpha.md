...
```bash
~/.pai/History/research/YYYY-MM-DD_description/
```
...
```
~/.pai/History/research/2025-10-26_podcast-analysis/
...
1. **Check if hooks captured the output:**
   ...
   ls -lt ~/.pai/History/research/ | head -5

   # Verify your research directory exists
   ls ~/.pai/History/research/YYYY-MM-DD_description/
   ```

2. **If hooks did NOT capture automatically:**
   ```bash
   # Create directory structure manually
   mkdir -p ~/.pai/History/research/YYYY-MM-DD_description/
...
3. **Confirm all files saved:**
   ```bash
   ls -lah ~/.pai/History/research/YYYY-MM-DD_description/
...
mkdir -p ~/.pai/History/research/$(date +%Y-%m-%d)_podcast-analysis/
...
ls -lah ~/.pai/History/research/$(date +%Y-%m-%d)_podcast-analysis/
...
6. **Save to history** - Final outputs to `~/.pai/History/research/YYYY-MM-DD_description/`
