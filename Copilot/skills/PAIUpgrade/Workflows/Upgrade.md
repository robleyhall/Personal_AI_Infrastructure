...
```
Use task tool with agent_type=general-purpose, run 4 agents in parallel:
...
```
Use task tool with agent_type=general-purpose, run 3 agents in parallel:
...
```
Use task tool with agent_type=general-purpose, run 1 agent in parallel with above:
