#!/bin/bash
# ---------------------------------------------------------------------------
# COPILOT PORT NOTE: Upstream invokes this as Claude Code's statusline hook.
# Copilot CLI has no statusline API, so the script is available here for:
#   - tmux/status-bar rendering (call from ~/.tmux.conf status-right)
#   - manual invocation (cat <session-json> | ./statusline-command.sh)
# Paths have been rewritten .claude→.pai. All functionality preserved.
# ---------------------------------------------------------------------------
# ═══════════════════════════════════════════════════════════════════════════════
# PAI Status Line
# ═══════════════════════════════════════════════════════════════════════════════
