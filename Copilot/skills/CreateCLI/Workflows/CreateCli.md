...
**Reference:** `Patterns.md and FrameworkComparison.md` (Configuration Flags section)
...
For more information, see ~/.pai/Bin/{{CLI_NAME}}/README.md
...
See: ~/.pai/Bin/{{CLI_NAME}}/README.md
```
...
Documentation: ~/.pai/Bin/{{CLI_NAME}}/README.md
```
...
3. Read: ~/.pai/Bin/notioncli/README.md
...
Use `Patterns.md` and `FrameworkComparison.md` as the reference for structure.
...
- [ ] Flag names match standard conventions (see `Patterns.md` and `FrameworkComparison.md`)
