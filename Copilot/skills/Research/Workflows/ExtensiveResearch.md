...
Task({ agent_type: "general-purpose", description: "[topic] angle 1", prompt: "Search for: [angle 1]. Return findings." })
Task({ agent_type: "general-purpose", description: "[topic] angle 2", prompt: "Search for: [angle 2]. Return findings." })
Task({ agent_type: "general-purpose", description: "[topic] angle 3", prompt: "Search for: [angle 3]. Return findings." })

// Gemini - 3 threads (multi-perspective, cross-domain)
Task({ agent_type: "general-purpose", description: "[topic] angle 4", prompt: "Search for: [angle 4]. Return findings." })
Task({ agent_type: "general-purpose", description: "[topic] angle 5", prompt: "Search for: [angle 5]. Return findings." })
Task({ agent_type: "general-purpose", description: "[topic] angle 6", prompt: "Search for: [angle 6]. Return findings." })

// Grok - 3 threads (contrarian, unbiased, fact-based)
Task({ agent_type: "general-purpose", description: "[topic] angle 7", prompt: "Search for: [angle 7]. Return findings." })
Task({ agent_type: "general-purpose", description: "[topic] angle 8", prompt: "Search for: [angle 8]. Return findings." })
Task({ agent_type: "general-purpose", description: "[topic] angle 9", prompt: "Search for: [angle 9]. Return findings." })
```
