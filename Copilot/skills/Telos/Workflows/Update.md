...
TELOS is {PRINCIPAL.NAME}'s life framework stored in `~/.pai/USER/TELOS/`. It contains:
...
!`head -50 ~/.pai/USER/TELOS/updates.md`

## View Specific TELOS File
!`FILE="$1"; cat ~/.pai/USER/TELOS/"$FILE"`
...
All backups are stored in: `~/.pai/USER/TELOS/Backups/`

All changes are logged in: `~/.pai/USER/TELOS/updates.md`
