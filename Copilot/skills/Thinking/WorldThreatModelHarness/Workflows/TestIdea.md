...
- World models must exist at `~/.pai/MEMORY/RESEARCH/WorldModels/`
...
```
Check ~/.pai/MEMORY/RESEARCH/WorldModels/ for all 11 model files.
...
Read all 11 model files from `~/.pai/MEMORY/RESEARCH/WorldModels/`.
...
1. Spawn up to 11 parallel agents (Task tool, `mode: "background"`)
2. Each agent:
