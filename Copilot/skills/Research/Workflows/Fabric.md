...
**Patterns Location:** `~/.pai/skills/Fabric/Patterns/`
...
Patterns are managed by the Fabric skill at `~/.pai/skills/Fabric/`.
...
**Full Pattern List:** `ls ~/.pai/skills/Fabric/Patterns/`
**Fabric Skill:** `~/.pai/skills/Fabric/SKILL.md`
**Fabric Documentation:** https://github.com/danielmiessler/fabric
**Pattern Templates:** See `~/.pai/skills/Fabric/Patterns/official_pattern_template/`
